        ...
        <div class="container-fluid table-filter-container border-radius-5 p-imp-30">
            <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap">
                ...
                <div class="d-flex align-items-center flex-wrap">
                    ...
                    <div class="form-group mr-2 mb-2">
                        <button type="button" class="btn btn-primary salary_table_form">{{ _trans('common.Search')
                            }}</button>
                    </div>
                    @endif
                </div>
            ...
            <div class="row dataTable-btButtons">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <table id="table"
                                class="table card-table table-vcenter datatable mb-0 w-100 salary_datatable_class">
                                <thead>
                                    <tr>
...
<input type="text" hidden id="salary_datatable_url"
    value="{{ route('user.profileDataTable',['user_id'=>$data['id'],'type'=>'salary']) }}">
@endsection
@section('script')
