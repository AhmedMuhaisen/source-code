                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <select name="status" class="form-control ot-form-control ot-input" required>
                                        <option value="">Select one</option>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="order_discount" placeholder="{{_trans('file.Discount')}}"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" class="form-control ot-form-control ot-input" placeholder="{{_trans('file.Note')}}"
                                        name="note"></textarea>
                                </div>
                            </div>
                        </div>
                        @if (hasPermission('sales_purchase_store'))
                        <div class="form-group d-flex justify-content-end mt-20">
                            <button type="submit" class="crm_theme_btn"
                                id="submit-btn">{{_trans('file.submit')}}</button>
                        </div>
                        @endif
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    if(is_imei[rowindex]) {
        ...
        htmlText = '<div class="col-md-12 form-group imei-section"><label class="form-label">IMEI or Serial Numbers</label><input type="text" name="imei_numbers" value="'+imeiNumbers+'" class="form-control imei_number" placeholder="Type imei or serial numbers and separate them by comma. Example:1001,2001" step="any"></div>';
