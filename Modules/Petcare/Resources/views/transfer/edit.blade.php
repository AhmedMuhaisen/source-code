                                            ...
                                            <tr>
                                                <?php
                                                        ...
                                                        if($product_transfer->variant_id) {
                                                            $product_variant_data = Modules\Petcare\Entities\SaleProductVariant::select('id', 'item_code')->FindExactProduct($product_data->id, $product_transfer->variant_id)->first();
                                                        ...
                                                        $product_batch_data = Modules\Petcare\Entities\SaleProductBatch::select('batch_no')->find($product_transfer->product_batch_id);
                                                    ?>
