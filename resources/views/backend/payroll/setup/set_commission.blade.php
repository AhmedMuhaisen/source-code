                    ...
                    <div class="d-flex flex-wrap gap-2  flex-lg-row justify-content-center align-content-center">
                        ...
                        <div class="align-self-center">
                            <label>
                                ...
                                <select class="form-select d-inline-block" id="entries" onchange="commissionSetTable()">
                        ...
                        <div class="align-self-center d-flex flex-wrap gap-2">
                            ...
                            @if (hasPermission('create_payroll_set'))
                            <div class="align-self-center">
                                <a href="javascript:void(0)" onclick="viewModal(`{{ @$data['create_url'] }}`)"
                        ...
                        <div class="align-self-center">
                            ...
                            <input type="hidden" id="daterange-input" onchange="commissionSetTable()">
                        </div>
                        ...
                        <div class="align-self-center">
                            <div class="search-box d-flex">
                                <input class="form-control" placeholder="{{ _trans('common.Search') }}" name="search"
                                    onkeyup="commissionSetTable()" autocomplete="off">
