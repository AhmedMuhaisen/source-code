...
@push('plugin-styles')
  <link href="{{ asset('public/theme/assets/plugins/bootstrap-datepicker/css/bootstrap-datepicker.min.css') }}" rel="stylesheet" />
@endpush
...
@push('plugin-scripts')
  <script src="{{ asset('public/theme/assets/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js') }}"></script>
  <script src="{{ asset('public/theme/assets/plugins/apexcharts/apexcharts.min.js') }}"></script>
@endpush

@push('custom-scripts')
  <script src="{{ asset('public/theme/assets/js/dashboard.js') }}"></script>
