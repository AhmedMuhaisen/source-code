    ...
    <div class="col-md-12">
        <div class="card ot-card">
            <div class="card-body">
                ...
                {!! Form::open(['route' => 'salePurchase.store', 'method' => 'post', 'files' => true, 'id' =>
                'purchase-form']) !!}
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                                ...
                                <div class="table-responsive mt-3">
                                    <table id="myTable" class="table table-hover order-list">
                                        ...
                                        <tbody class="tbody">
                                            ...
                                            <?php
                                                        ...
                                                        if($product_quotation->variant_id) {
                                                            $product_variant_data = Modules\Petcare\Entities\SaleProductVariant::select('item_code', 'additional_cost')->FindExactProduct($product_quotation->product_id, $product_quotation->variant_id)->first();
                                            ...
                                            <tr>
                                                <?php
                                                            ...
                                                            $tax_data = DB::table('sale_taxes')->where('rate', $product_quotation->tax_rate)->first();
                                                            ...
                                                            $product_batch_data = Modules\Petcare\Entities\SaleProductBatch::select('batch_no', 'expired_date')->find($product_quotation->product_batch_id);
                                                        ?>
                                                ...
                                                <td><input type="number"
                                                        ...
                                                        value="{{$product_quotation->qty}}" step="any" required /></td>
                                                <td class="recieved-product-qty d-none"><input type="number"
                                                        class="form-control ot-form-control ot-input recieved"
                                                        name="recieved[]" value="{{$product_quotation->qty}}"
                                                        step="any" /></td>
                                                <td class="net_unit_cost">{{ number_format((float)$net_unit_cost, 2,
                                                    '.', '') }} </td>
                                                <td class="discount">{{
                                                    number_format((float)$product_quotation->discount, 2, '.', '')
                                                    }}</td>
                                                <td class="tax">{{ number_format((float)$tax, 2, '.', '') }}</td>
                                                <td class="sub-total">{{ number_format((float)$sub_total, 2, '.',
                                                    '') }}</td>
                                        ...
                                        <tfoot class="tfoot active">
                                            ...
                                            <th id="total">{{ number_format((float)$ot_crm_quotation_data->total_cost,
                                                2, '.', '') }}</th>
                                            <th><i class="dripicons-trash"></i></th>
                                        </tfoot>
                                    </table>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input type="hidden" name="total_cost"
                                        value="{{$ot_crm_quotation_data->total_cost}}" />
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                ...
                <form>
                    <div class="row modal-element">
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <select name="edit_tax_rate" class="form-control ot-form-control ot-input">
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <select name="edit_unit" class="form-control ot-form-control ot-input">
                            </select>
                        </div>
                    </div>
...
function productSearch(data){
    $.ajax({
        type: 'GET',
        url: '../../purchases/ot_crm_product_search',
        data: {
            data: data
        },
