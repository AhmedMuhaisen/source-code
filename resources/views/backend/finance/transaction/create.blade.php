            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="date" name="date" class="form-control ot_input ot-form-control ot_input-date"
                ...
                <div class="col-lg-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="number" name="amount" class="form-control ot-form-control ot_input"
                            ...
                            required placeholder="{{ _trans('common.500') }}">
                ...
                <div class="col-lg-6">
                    <div class="form-group mb-3">
                        <label class="form-label">{{ _trans('account.Payment Method') }}</label>
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <textarea type="text" name="description" rows="5" class="form-control ot_input mt-0" placeholder="{{ _trans('common.Enter Description') }}"
