                            ...
                            <div class="table-responsive">
                                <table id="myTable" class="table table-hover order-list">
                                    ...
                                    <tbody class="tbody">
                                        ...
                                        <tr>
                                            <?php
                                                        $product = Modules\Petcare\Entities\SaleProduct::find($id);
                                                        if($ot_crm_product_data->variant_list && $variant_list[$key]) {
                                                            $product_variant_data = Modules\Petcare\Entities\SaleProductVariant::select('item_code')->FindExactProduct($id, $variant_list[$key])->first();
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody class="tbody">
                                        ...
                                        <tr>
                                            ...
                                            @else
                                            <td>
                                                <img src="{{url('public/theme/assets/images/logo.png')}}" height="60"
                                                    width="60">
                                            </td>
                                            @endif            
                                ...
                                <table id="diffPrice-table" class="table table-hover table-bordered">
                                    ...
                                    <tbody class="tbody">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                            $product_warehouse = Modules\Petcare\Entities\SaleProductWarehouse::FindProductWithoutVariant($ot_crm_product_data->id, $warehouse->id)->first();
                                                        ?>
...
@section('script')
<script type="text/javascript" src="{{ url('Modules\Petcare\public\tinymce\js\tinymce\tinymce.min.js') }}"></script>
<script type="text/javascript" src="{{ url('Modules\Petcare\public\js\dropzone.js') }}"></script>
