    ...
    <div id="receipt-data">
        ...
        <table class="table-data">
             <tbody class="tbody">
                ...
                <?php 
                    $ot_crm_product_data = Modules\Petcare\Entities\SaleProduct::find($product_sale_data->product_id);
                    if($product_sale_data->variant_id) {
                        $variant_data = Modules\Petcare\Entities\SaleVariant::find($product_sale_data->variant_id);
                        $product_name = $ot_crm_product_data->name.' ['.$variant_data->name.']';
                    }
                    elseif($product_sale_data->product_batch_id) {
                        $product_batch_data = Modules\Petcare\Entities\SaleProductBatch::select('batch_no')->find($product_sale_data->product_batch_id);
