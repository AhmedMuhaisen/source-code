                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="customer_id_hidden"
                                        value="{{ $ot_crm_quotation_data->customer_id }}" />
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="warehouse_id_hidden"
                                        value="{{$ot_crm_quotation_data->warehouse_id}}" />
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{_trans('file.Biller')}} <span class="text-danger">*</span></label>
                                    <input type="hidden" name="biller_id_hidden"
                                        value="{{$ot_crm_quotation_data->biller_id}}" />
                                    <select required name="biller_id"
                                        class="form-select select2-input ot-input mb-3 modal_select2"
                                        data-live-search="true" title="Select Biller...">
                                    ...
                                    <table id="myTable" class="table table-hover order-list">
                                        ...
                                        <tbody class="tbody">
                                            <?php
                                                    ...
                                                    ?>
                                            @foreach($ot_crm_product_quotation_data as $product_quotation)
                                            <tr>
                                                <?php
                                                        $product_data = DB::table('sale_products')->find($product_quotation->product_id);
                                                        if($product_quotation->variant_id) {
                                                            $product_variant_data = Modules\Petcare\Entities\SaleProductVariant::select('item_code')->FindExactProduct($product_quotation->product_id, $product_quotation->variant_id)->first();
                                                        ...
                                                        $tax = DB::table('sale_taxes')->where('rate',$product_quotation->tax_rate)->first();
                                                        ...
                                                        $product_batch_data = Modules\Petcare\Entities\SaleProductBatch::select('batch_no')->find($product_quotation->product_batch_id);
                                                    ?>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text"
                                                        class="form-select select2-input ot-input mb-3 modal_select2 batch-no"
                                                ...
                                                <td><input type="number"
                                                        class="form-select select2-input ot-input mb-3 modal_select2 qty"
                                                        name="qty[]" value="{{$product_quotation->qty}}" step="any"
                                                        required /></td>
                                                ...
                                                <td class="tax">{{ number_format((float)$product_quotation->tax, 2,
                                                    '.', '') }}</td>
                                                <td class="sub-total">{{
                                                ...
                                                <input type="hidden" class="product-price" name="product_price[]"
                                                    value="{{$product_price}}" />
                                        ...
                                        <tfoot class="tfoot active">
                                            ...
                                            <th id="total-qty">{{$ot_crm_quotation_data->total_qty}}</th>
                                            <th></th>
                                            <th id="total-discount">{{
                                                number_format((float)$ot_crm_quotation_data->total_discount, 2, '.',
                                                '') }}</th>
                                            <th id="total-tax">{{
                                                number_format((float)$ot_crm_quotation_data->total_tax, 2, '.', '')}}
                                            </th>
                                            <th id="total">{{
                                                number_format((float)$ot_crm_quotation_data->total_price, 2, '.', '')
                                                }}</th>
                                            <th><i class="dripicons-trash"></i></th>
                                        </tfoot>
                                    </table>
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input type="hidden" name="total_qty" value="{{$ot_crm_quotation_data->total_qty}}" />
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input type="hidden" name="total_discount"
                                        value="{{$ot_crm_quotation_data->total_discount}}" />
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input type="hidden" name="total_tax" value="{{$ot_crm_quotation_data->total_tax}}" />
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input type="hidden" name="total_price"
                                        value="{{$ot_crm_quotation_data->total_price}}" />
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input type="hidden" name="item" value="{{$ot_crm_quotation_data->item}}" />
                                    <input type="hidden" name="order_tax" value="{{$ot_crm_quotation_data->order_tax}}" />
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input type="hidden" name="grand_total"
                                        value="{{$ot_crm_quotation_data->grand_total}}" />
                        ...
                        <div class="row mt-3">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="hidden" name="order_tax_rate_hidden"
                                        value="{{$ot_crm_quotation_data->order_tax_rate}}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="order_discount_value"
                                        class="form-select select2-input ot-input mb-3 modal_select2"
                                        id="order-discount-val" value="{{$ot_crm_quotation_data->order_discount}}">
                                    <input type="hidden" name="order_discount"
                                        class="form-select select2-input ot-input mb-3 modal_select2"
                                        id="order-discount" value="{{$ot_crm_quotation_data->order_discount}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="shipping_cost"
                                        class="form-select select2-input ot-input mb-3 modal_select2"
                                        value="{{$ot_crm_quotation_data->shipping_cost}}" step="any" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{_trans('file.Sale Status')}} <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{_trans('file.Payment Status')}} <span class="text-danger">*</span></label>
                        ...
                        <div id="payment">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="paid_by_id"
                                            ...
                                            <option value="2">{{_trans('common.Gift Card')}}</option>
                                            <option value="3">{{_trans('common.Credit Card')}}</option>
                                            <option value="4">{{_trans('common.Cheque')}}</option>
                                            <option value="5">{{_trans('common.Paypal')}}</option>
                                            <option value="6">{{_trans('common.Deposit')}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="gift_card_id" name="gift_card_id"
                                            class="form-select select2-input ot-input mb-3 modal_select2"
                                            data-live-search="true" title="Select Gift Card..."></select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea rows="3" class="form-select select2-input ot-input mb-3 modal_select2"
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" class="form-select select2-input ot-input mb-3 modal_select2"
                                        name="sale_note">{{$ot_crm_quotation_data->note}}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                    ...
                    <div class="row modal-element">
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <input type="number" name="edit_unit_price"
                                class="form-select select2-input ot-input mb-3 modal_select2" step="any">
                        </div>
                        <?php
                                $tax_name_all[] = 'No Tax';
                                $tax_rate_all[] = 0;
...
<script type="text/javascript">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (flag) {
                    ...
                    cols += '<td>' + data[1] + '</td>';
                    if(data[12]) {
                        cols += '<td><input type="text" class="form-select select2-input ot-input mb-3 modal_select2 batch-no" value="'+batch_no[pos]+'" required/> <input type="hidden" class="product-batch-id" name="product_batch_id[]" value="'+product_batch_id[pos]+'"/> </td>';
                    }
                    else {
                        cols += '<td><input type="text" class="form-select select2-input ot-input mb-3 modal_select2 batch-no" disabled/> <input type="hidden" class="product-batch-id" name="product_batch_id[]"/> </td>';
                    }
                    cols += '<td><input type="number" class="form-select select2-input ot-input mb-3 modal_select2 qty" name="qty[]" value="1" step="any" required/></td>';
    ...
    function edit(){
        ...
        if(imeiNumbers || is_imei[rowindex]) {
            htmlText = '<div class="col-md-12 form-group imei-section"><label>IMEI or Serial Numbers</label><input type="text" name="imei_numbers" value="'+imeiNumbers+'" class="form-select select2-input ot-input mb-3 modal_select2 imei_number" placeholder="Type imei or serial numbers and separate them by comma. Example:1001,2001" step="any"></div>';
