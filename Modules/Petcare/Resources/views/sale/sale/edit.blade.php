    ...
    <div class="col-md-12">
        <div class="card ot-card">
            <div class="card-body">
                ...
                {!! Form::open(['route' => ['saleSale.update', $ot_crm_sale_data->id], 'method' => 'post', 'files' =>
                ...
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="created_at" required
                                        ...
                                        strtotime($ot_crm_sale_data->created_at->toDateString()))}}" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{_trans('file.reference')}}</label>
                                    <p><strong>{{ $ot_crm_sale_data->reference_no }}</strong></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="customer_id_hidden"
                                        value="{{ $ot_crm_sale_data->customer_id }}" />
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="warehouse_id_hidden"
                                        value="{{$ot_crm_sale_data->warehouse_id}}" />
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="biller_id_hidden"
                                        value="{{$ot_crm_sale_data->biller_id}}" />
                                ...
                                <div class="table-responsive mt-3">
                                    <table id="myTable" class="table table-hover order-list">
                                        ...
                                        <tbody class="tbody">
                                            ...
                                            <tr>
                                                <?php
                                                        $product_data = DB::table('sale_products')->find($product_sale->product_id);
                                                        if($product_sale->variant_id){
                                                            $product_variant_data = Modules\Petcare\Entities\SaleProductVariant::select('id', 'item_code')->FindExactProduct($product_data->id, $product_sale->variant_id)->first();
                                                        ...
                                                        $tax = DB::table('sale_taxes')->where('rate',$product_sale->tax_rate)->first();
                                                        $unit_name = array();
                                                        $unit_operator = array();
                                                        ...
                                                        $product_batch_data = Modules\Petcare\Entities\SaleProductBatch::select('batch_no', 'expired_date')->find($product_sale->product_batch_id);
                                                    ?>
                                                ...
                                                <td><input type="number"
                                                        ...
                                                        value="{{$product_sale->qty}}" step="any" required /></td>
                                                ...
                                                <td>{{date("Y-m-d", strtotime($product_batch_data->expired_date))}}
                                                </td>
                                                @else
                                                <td>
                                                    <input type="hidden" class="product-batch-id"
                                                ...
                                                <td class="tax">{{ number_format((float)$product_sale->tax, 2, '.',
                                                    '') }}</td>
                                                <td class="sub-total">{{ number_format((float)$product_sale->total,
                                                    2, '.', '') }}</td>
                                        ...
                                        <tfoot class="tfoot active">
                                            ...
                                            <th id="total-qty">{{$ot_crm_sale_data->total_qty}}</th>
                                            <th></th>
                                            <th></th>
                                            <th></th>
                                            <th id="total-discount">{{
                                                number_format((float)$ot_crm_sale_data->total_discount, 2, '.', '') }}
                                            </th>
                                            <th id="total-tax">{{ number_format((float)$ot_crm_sale_data->total_tax,
                                                2, '.', '')}}</th>
                                            <th id="total">{{ number_format((float)$ot_crm_sale_data->total_price, 2,
                                                '.', '') }}</th>
                                            <th><i class="dripicons-trash"></i></th>
                                        </tfoot>
                                    </table>
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input type="hidden" name="total_qty" value="{{$ot_crm_sale_data->total_qty}}" />
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input type="hidden" name="total_discount"
                                        value="{{$ot_crm_sale_data->total_discount}}" />
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input type="hidden" name="total_tax" value="{{$ot_crm_sale_data->total_tax}}" />
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input type="hidden" name="total_price" value="{{$ot_crm_sale_data->total_price}}" />
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input type="hidden" name="item" value="{{$ot_crm_sale_data->item}}" />
                                    <input type="hidden" name="order_tax" value="{{$ot_crm_sale_data->order_tax}}" />
                                </div>
                            </div>
                            <div class="col-md-2">
                                @if($ot_crm_sale_data->coupon_id)
                                @php
                                $coupon_data = DB::table('coupons')->find($ot_crm_sale_data->coupon_id);
                                @endphp
                                ...
                                <input type="hidden" name="coupon_discount"
                                    value="{{$ot_crm_sale_data->coupon_discount}}">

                                @else
                                <input type="hidden" name="coupon_active" value="0" />
                                @endif
                                <div class="form-group">
                                    <input type="hidden" name="grand_total" value="{{$ot_crm_sale_data->grand_total}}" />
                                </div>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="hidden" name="order_tax_rate_hidden"
                                        value="{{$ot_crm_sale_data->order_tax_rate}}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control ot-form-control ot-input" name="order_discount_type">
                                        @if($ot_crm_sale_data->order_discount_type == 'Percentage')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>
                                        {{_trans('file.Order Discount Value')}}
                                    </label>
                                    <input type="number" name="order_discount_value"
                                        class="form-control ot-form-control ot-input"
                                        value="@if($ot_crm_sale_data->order_discount_value){{$ot_crm_sale_data->order_discount_value}}@else{{$ot_crm_sale_data->order_discount}}@endif"
                                        step="any" />
                                    <input type="hidden" name="order_discount"
                                        value="{{$ot_crm_sale_data->order_discount}}" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="shipping_cost"
                                        class="form-control ot-form-control ot-input"
                                        value="{{$ot_crm_sale_data->shipping_cost}}" step="any" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="sale_status_hidden"
                                        value="{{$ot_crm_sale_data->sale_status}}" />
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>
                                        <strong>{{_trans('file.Coupon Discount')}}</strong>
                                    </label>
                                    <p class="mt-2 pl-2"><strong id="coupon-text">{{
                                            number_format((float)$ot_crm_sale_data->coupon_discount, 2, '.', '')
                                            }}</strong></p>
                                </div>
                            </div>
                            @endif
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" class="form-control ot-form-control ot-input"
                                        name="sale_note">{{ $ot_crm_sale_data->sale_note }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" class="form-control ot-form-control ot-input"
                                        name="staff_note">{{ $ot_crm_sale_data->staff_note }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="hidden" name="payment_status"
                                        value="{{$ot_crm_sale_data->payment_status}}" />
                                    <input type="hidden" name="paid_amount" value="{{$ot_crm_sale_data->paid_amount}}" />
                                </div>
                            </div>
                        </div>
                ...
                <form>
                    <div class="row modal-element">
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <input type="number" name="edit_unit_price" class="form-control ot-form-control ot-input"
                                step="any">
                        </div>
                        <?php
                            $tax_name_all[] = 'No Tax';
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6 form-group warehouse-section">
                        <label>{{_trans('file.Warehouse')}} *</strong> </label>
                    ...
                    <div class="col-md-6 form-group">
                        <label>{{_trans('file.Cash in Hand')}} *</strong> </label>
...
<script type="text/javascript">
    ...
    $("#myTable").on("change", ".batch-no", function () {
        ...
        $.get('../../sale/check-batch-availability/' + product_id + '/' + $(this).val() + '/' + warehouse_id, function(data) {
            if(data['message'] != 'ok') {
                alert(data['message']);
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(flag){
                    ...
                    cols += '<td>' + data[1] + '</td>';
                    cols += '<td><input type="number" class="form-control ot-form-control ot-input qty" name="qty[]" value="'+data[14]+'" step="any" required/></td>';
                    if(data[12]) {
