    ...
    <div class="col-md-12">
        <div class="card ot-card">
            <div class="card-header d-flex align-items-center">
                <h4>{{_trans('file.Update Quotation')}}</h4>
            </div>
            <div class="card-body">
           
                {!! Form::open(['route' => ['saleQuotation.update', $ot_crm_quotation_data->id], 'method' => 'post',
                'files' => true, 'id' => 'payment-form']) !!}
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <p><strong>{{ $ot_crm_quotation_data->reference_no }}</strong></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="supplier_id_hidden"
                                        value="{{ $ot_crm_quotation_data->supplier_id }}" />
                                            ...
                                            <tr>
                                                <?php
                                                        ...
                                                        if($product_quotation->variant_id) {
                                                            $product_variant_data = Modules\Petcare\Entities\SaleProductVariant::select('id', 'item_code')->FindExactProduct($product_data->id, $product_quotation->variant_id)->first();
                                                            $product_variant_id = $product_variant_data->id;
                                                            $product_data->code = $product_variant_data->item_code;
                                                        }
                                                        else
                                                            $product_variant_id = null;
                                                        $customer = DB::table('sale_customers')->find($ot_crm_quotation_data->customer_id);

                                                        $customer_group = DB::table('sale_customer_groups')->find($customer->customer_group_id);
                                                ...
                                                <td><input type="number"
                                                        ...
                                                        value="{{$product_quotation->qty}}" step="any" required />
                                                </td>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>
                                        <strong>{{_trans('file.Order Discount')}}</strong>
                                    </label>
                                    <input type="number" name="order_discount"
                                        class="form-control ot-form-control ot-input"
                                        value="{{$ot_crm_quotation_data->order_discount}}" step="any" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="quotation_status_hidden"
                                        value="{{$ot_crm_quotation_data->quotation_status}}">
                                    <select name="quotation_status"
                                        class="form-select select2-input ot-input mb-3 modal_select2">
                                        <option value="1">{{_trans('file.Pending')}}</option>
                                        <option value="2">{{_trans('file.Sent')}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" class="form-control ot-form-control ot-input"
                                        name="note">{{ $ot_crm_quotation_data->note }}</textarea>
                                </div>
                            </div>
                        </div>
                        @if (hasPermission('sales_quotation_update'))
                        <div class="form-group">
