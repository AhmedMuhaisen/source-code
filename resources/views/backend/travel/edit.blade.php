                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        <label class="form-label">{{ _trans('project.Employee') }}</label>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="travel_type" class="form-control select2" id="award_type" required>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="motive" class="form-control ot-form-control ot_input"
                                            required value="{{ @$data['edit'] ? @$data['edit']->purpose : '' }}">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-">
                                        ...
                                        <input type="text" name="place" class="form-control ot-form-control ot_input"
                                            required value="{{ @$data['edit'] ? @$data['edit']->place : '' }}">
                                        @if ($errors->has('place'))
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="mode" class="form-control select2" required>
                                            <option value="bus" {{ @$data['edit'] == 'bus' ? 'selected' : '' }}>
                                                {{ _trans('travel.Bus') }}</option>
                                            <option value="train" {{ @$data['edit'] == 'train' ? 'selected' : '' }}>
                                                {{ _trans('travel.Train') }}</option>
                                            <option value="plane" {{ @$data['edit'] == 'plane' ? 'selected' : '' }}>
                                                {{ _trans('travel.Plane') }}</option>
                                        </select>
                                        @if ($errors->has('mode'))
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="ot_fileUploader left-side mb-3">
                                            <input class="form-control" type="text" placeholder="{{ _trans('common.Attachment') }}" name="attachment" readonly="" id="placeholder">
