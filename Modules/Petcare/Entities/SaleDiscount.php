...
class SaleDiscount extends Model
{
    ...
    {
        return \Modules\Petcare\Database\factories\SaleDiscountFactory::new();
    }

    public function discountPlans()
    {
        return $this->belongsToMany('Modules\Petcare\Entities\SaleDiscountPlan', 'sale_discount_plan_discounts', 'discount_id', 'discount_plan_id');
    }
}
