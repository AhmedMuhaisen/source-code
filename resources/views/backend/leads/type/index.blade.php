                    ...
                    <div class="d-flex flex-wrap gap-2  flex-lg-row justify-content-center align-content-center">
                        ...
                        <div class="align-self-center">
                            <label>
                                ...
                                <select class="form-select d-inline-block" id="entries" onchange="types_datatable()">
                        ...
                        <div class="align-self-center d-flex flex-wrap gap-2">
                            <!-- add btn -->
                            <div class="align-self-center">
                                @if (hasPermission('lead_type_create'))
                                <a href="#" role="button" class="btn-add" data-bs-toggle="tooltip"
                                    data-bs-placement="right" onclick="mainModalOpen('{{ route('type.create') }}')"
                        ...
                        <div class="align-self-center">
                            <div class="search-box d-flex">
                                <input class="form-control" placeholder="{{ _trans('common.Search') }}" name="search"
                                    onkeyup="types_datatable()" autocomplete="off">
