...
<div class="profile-content">
            ...
            <div class="container-fluid table-filter-container border-radius-5 p-imp-30 d-none">
                    ...
                    <div class="d-flex align-items-center flex-wrap">
                        @if (hasPermission('advance_salaries_search'))
                            ...
                            <div class="form-group mr-2 mb-2">
                                <select name="return_status" id="return_status" class="form-control select2 custom-select-width">
                            ...
                            <div class="form-group mr-2 mb-2">
                                <button type="button" class="btn btn-primary advance_table_form">{{ _trans('common.Search') }}</button>
                            </div>
                        @endif
                            @if (hasPermission('advance_type_menu'))
                                <div class="form-group mr-2 mb-2">
                                    <a href="{{ route('hrm.payroll_advance_type.index') }}" class="btn btn-primary ">{{ _trans('payroll.Type List')  }}</a>
                                </div>
                            @endif
                            @if (hasPermission('advance_salaries_create'))
                                <div class="form-group mr-2 mb-2">
                                    <a href="{{ route('hrm.payroll_advance_salary.create') }}" class="btn btn-primary "> <i
                                            class="fa fa-plus-square pr-2"></i> {{ _trans('common.Add') }}</a>
                                </div>
                            @endif
                    </div>
                ...
                <div class="row dataTable-btButtons">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <table id="table" class="table card-table table-vcenter datatable mb-0 w-100 payroll_advance_table">
                                    <thead>
                                        <tr>
    ...
    <input type="text" hidden id="advance_salary_report_data_url" value="{{ route('staff.authUserTable',['type'=>'advance']) }}">
@endsection
@section('script')
