...
class Sale extends Model
{
    ...
    {
        return \Modules\Petcare\Database\factories\SaleFactory::new();
    }
    ...
    {
        return $this->hasMany('Modules\Petcare\Entities\SaleProductSale');
    }

    public function saleSingleProduct()
    {
        return $this->belongsTo('Modules\Petcare\Entities\SaleProductSale', 'id', 'sale_id');
    }
