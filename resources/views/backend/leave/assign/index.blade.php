                        ...
                        <div class="align-self-center d-flex flex-wrap gap-2">
                            ...
                            <div class="align-self-center">
                                <a href="javascript:;" role="button" class="btn-add" data-bs-toggle="tooltip"
                                    onclick="mainModalOpen(`{{ route('assignLeave.create') }}`)"
                        ...
                        <div class="align-self-center">
                            <div class="search-box d-flex">
                                <input class="form-control" placeholder="{{ _trans('common.Search') }}" name="search"
                                    onkeyup="leaveAssignDatatable()" autocomplete="off">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <a class="dropdown-item" href="#"
                                            onclick="tableAction('active', `{{ route('assignLeave.statusUpdate') }}`)"><span
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="#" aria-current="true"
                                            onclick="tableAction('inactive', `{{ route('assignLeave.statusUpdate') }}`)">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="#"
                                            onclick="tableAction('delete', `{{ route('assignLeave.delete_data') }}`)">
