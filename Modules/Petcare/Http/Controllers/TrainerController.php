...
use Modules\Petcare\Entities\SaleSupplier;
...
class TrainerController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('sale::service.trainer.index',compact('data'));
    }
    ...
    public function importSupplier(Request $request)
    {
        ...
        if($ext != 'csv')
            return redirect()->route('trainer.index')->with('not_permitted', 'Please upload a CSV file');
