                ...
                <div class="align-self-center">
                    <div
                        ...
                        <div class="align-self-center d-flex gap-2">
                            ...
                            <div class="align-self-center">
                                <a href="{{ route('trainer.create') }}" role="button" class="btn-add"
                ...
                <table class="table table-bordered">
                    ...
                    <tbody class="tbody">
                        ...
                        <?php
                                ...
                                $purchaseData = Modules\Petcare\Entities\SalePurchase::where([
                        ...
                        <tr data-id="{{$supplier->id}}">
                            ...
                            @else
                            <td class=""><img class="staff-profile-image-small" src="{{ url('public/theme/assets/images/logo.png') }}" alt=""></td>
                            @endif
                            <td>
                                {{$supplier->name}}
...
<div id="clearDueModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
    ...
    <div role="document" class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            {!! Form::open(['route' => 'trainer.clearDue', 'method' => 'post']) !!}
