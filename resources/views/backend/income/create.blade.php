  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">@if(@$data['edit']) {{ _trans('common.Edit') }} @else {{ _trans('common.Create') }} @endif {{ _trans('common.Income') }}</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ _trans('common.Dashboard') }}</a></li>
              <li class="breadcrumb-item active">@if(@$data['edit']) {{ _trans('common.Edit') }} @else {{ _trans('common.Create') }} @endif {{ _trans('common.Income') }}</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                ...
                @else
                    {!! Form::open(['route' => 'income.store', 'enctype' => 'multipart/form-data','method' => 'post', 'languages' => true, 'id' => 'portfolio-form']) !!}
                @endif
                  <div class="card-body">
                      <div class="row">
                          <div class="col-lg-6">
                  ...
                  <div class="card-footer">
                    <a href="{{ url('dashboard/income') }}" class="btn btn-default float-left">{{ _trans('common.Back') }}</a>
