  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">@if(@$data['edit']) {{ _trans('common.Edit') }} @else {{ _trans('common.Create') }} @endif {{ _trans('common.Expense-Head') }}</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ _trans('common.Dashboard') }}</a></li>
              <li class="breadcrumb-item active">@if(@$data['edit']) {{ _trans('common.Edit') }} @else {{ _trans('common.Create') }} @endif {{ _trans('common.Expense-Head') }}</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <div class="card card-primary">
                ...
                @endif
                  ...
                  <div class="card-footer">
                    <a href="{{ url('dashboard/expense-head') }}" class="btn btn-default float-left">{{ _trans('common.Back') }}</a>
