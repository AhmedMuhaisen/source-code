        ...
        <div class="col-md-12">
            <div class="card ot-card">
                <div class="card-body">
                    ...
                    {!! Form::open(['route' => 'saleQuotation.store', 'method' => 'post', 'files' => true, 'id' =>
                    'quotation-form']) !!}
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        <label class="form-label">{{_trans('file.Order Discount')}}</label>
                                        <input type="number" name="order_discount" placeholder="{{_trans('file.Order Discount')}}"
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control ot-form-control ot-input" name="quotation_status">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group ">
                                        ...
                                        <textarea rows="5" name="note" placeholder="{{_trans('file.Note')}}"
                                            class="form-control ot-form-control ot-input"></textarea>
                                    </div>
                                </div>
                            </div>
                            @if (hasPermission('sales_quotation_store'))
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            ...
                            <input type="number" name="edit_qty" class="form-control ot-form-control ot_input" step="any">
                        </div>
                        <div class="form-group">
                            <label class="form-label">{{_trans('file.Unit Discount')}}</label>
                            <input type="number" name="edit_discount" class="form-control ot-form-control ot_input" step="any">
                        </div>
                        <div class="form-group">
                            <label class="form-label">{{_trans('file.Unit Price')}}</label>
                            <input type="number" name="edit_unit_price" class="form-control ot-form-control ot_input" step="any">
                        </div>
                        <?php
                $tax_name_all[] = 'No Tax';
                $tax_rate_all[] = 0;
