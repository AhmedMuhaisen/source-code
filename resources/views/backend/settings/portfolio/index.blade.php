                    ...
                    <div class="d-flex flex-wrap gap-2  flex-lg-row justify-content-center align-content-center">
                        ...
                        <div class="align-self-center">
                            <label>
                                ...
                                <select class="form-select d-inline-block" id="entries" onchange="portfolioTable()">
                        ...
                        <div class="align-self-center d-flex flex-wrap gap-2">
                            <!-- add btn -->
                            <div class="align-self-center">
                                @if (hasPermission('portfolio_create'))
                                <a href="{{ route('portfolio.create') }}" role="button" class="btn-add"
                        ...
                        <div class="align-self-center">
                            ...
                            <input type="hidden" id="daterange-input" onchange="portfolioTable()">
                        </div>
                        ...
                        <div class="align-self-center">
                            <div class="search-box d-flex">
                                <input class="form-control" placeholder="{{ _trans('common.Search') }}" name="search"
                                    onkeyup="portfolioTable()" autocomplete="off">
