...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">{{ _trans('common.Expense Details') }}</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ _trans('common.Dashboard') }}</a></li>
            <li class="breadcrumb-item"><a href="{{ route('expense.index') }}">{{ _trans('common.Expense') }}</a></li>
            <li class="breadcrumb-item active">{{ _trans('common.Expense Details') }}</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  ...
  <section class="content">
    ...
    <div class="card">
              ...
              <div class="col-sm-3">
                <div class="info-box bg-light">
                  <div class="info-box-content">
                    <span class="info-box-text text-center text-muted">{{ _trans('common.Expense Head') }}</span>
                    <span
      ...
      <div class="text-center mt-5 mb-3">
        <a href="{{ route('expense.index') }}" class="btn btn-sm btn-default">{{_trans('common.Back')}}</a>
      </div>
      <!-- /.card-body -->
    </div>
    <!-- /.card -->
