    ...
    <div class="col-md-12">
        <div class="card ot-card">
            ...
            <div class="card-body">
                ...
                {!! Form::open(['route' => ['saleReturn.update', $ot_crm_return_data->id], 'method' => 'put', 'files'
                ...
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="customer_id_hidden"
                                        value="{{ $ot_crm_return_data->customer_id }}" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="biller_id_hidden"
                                        value="{{$ot_crm_return_data->biller_id}}" />
                                    ...
                                    <table id="myTable" class="table table-hover order-list">
                                            ...
                                            <tr>
                                                <?php
                                                        ...
                                                        if($product_return->variant_id) {
                                                            $product_variant_data = Modules\Petcare\Entities\SaleProductVariant::select('id', 'item_code')->FindExactProduct($product_data->id, $product_return->variant_id)->first();
                                                ...
                                                <td class="net_unit_price">{{
                                                    number_format((float)$product_return->net_unit_price, 2, '.',
                                                    '') }} </td>
                                                <td class="discount">{{
                                        ...
                                        <tfoot class="tfoot active">
                                            ...
                                            <th id="total-tax">{{ number_format((float)$ot_crm_return_data->total_tax,
                                                2, '.', '')}}</th>
                                            <th id="total">{{ number_format((float)$ot_crm_return_data->total_price,
                                                2, '.', '') }}</th>
                                            <th><i class="dripicons-trash"></i></th>
                                        </tfoot>
                                    </table>
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input type="hidden" name="total_qty" value="{{$ot_crm_return_data->total_qty}}" />
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input type="hidden" name="total_tax" value="{{$ot_crm_return_data->total_tax}}" />
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input type="hidden" name="total_price"
                                        value="{{$ot_crm_return_data->total_price}}" />
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input type="hidden" name="item" value="{{$ot_crm_return_data->item}}" />
                                    <input type="hidden" name="order_tax" value="{{$ot_crm_return_data->order_tax}}" />
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                        ...
                        @if (hasPermission('sales_return_sale_store'))
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6 form-group warehouse-section">
                        <label class="form-label">{{_trans('file.Warehouse')}} *</strong> </label>
                    ...
                    <div class="col-md-6 form-group">
                        <label class="form-label">{{_trans('file.Cash in Hand')}} *</strong> </label>
                        <input type="number" name="cash_in_hand" required class="form-control ot-form-control ot-input">
                    </div>
                    <div class="col-md-12 form-group mt-20 d-flex justify-content-end">
