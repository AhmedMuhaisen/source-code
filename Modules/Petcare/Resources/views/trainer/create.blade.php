                    ...
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <x-input type="text" title="Trainer Full Name" name="name" value="" />
                                <!-- Col -->
                            </div>
                            <div class="col-sm-6">
                                <x-input type="email" title="Email address" name="email" value="" />
                            </div><!-- Col -->
                        </div><!-- Row -->
                        <div class="row">

                            <div class="col-sm-6">
                                <x-input type="number" name="phone" title="phone" value="" />
                            </div>


                            <div class="col-sm-6">
                                <x-input type="text" title="Country" name="country" value="" />
                            </div> <!-- Col -->
                        </div><!-- Row -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <x-input type="text" title="State/Region" name="state" value="" />
                            </div> <!-- Col -->

                            <div class="col-sm-6">
                                <x-input type="text" title="City" name="city" value="" />
                            </div> <!-- Col -->
                        </div><!-- Row -->

                        <div class="row">
                            <div class="col-sm-6">
                                <x-input type="text" title="Address" name="address" value="" />
                            </div> <!-- Col -->
                            <div class="col-sm-6">
                                <x-input type="text" title="Zip/Postal Code" name="postal_code" value="" />
                            </div> <!-- Col -->
                        </div><!-- Row -->
                                ...
                                <div class="list">
                                    ...
                                    <label for="{{ 'skill' . $skill->id }}" class="task">
                                        <input type="checkbox" onchange="counterSelected()" name="skills[]"
                                            class="skills_checkbox" @if(is_array(old('skills')) && in_array($skill->id,
                                        old('skills'))) checked @endif id="{{ 'skill' . $skill->id }}" value="{{
                                        $skill->id }}">
                                        {{ $skill->name}}
                                    </label>
                                    @endforeach
                        ...
                        <div class="row">
                            ...
                            <x-input type="text" title="Year Of Expirinace" name="expirinace" value="" />
                        ...
                        <div class="hour_work_countiner p-3">
                            <h3 class="mb-3">Houre Work</h3>
                            
                            <x-hour_work day="Saturday"/>
                            <x-hour_work day="Sunday"/>
                            <x-hour_work day="Monday"/>
                            <x-hour_work day="Tuesday"/>
                            <x-hour_work day="Wednesday"/>
                            <x-hour_work day="Thursday"/>
                            <x-hour_work day="Friday"/>
