    ...
    <div class="col-md-12">
        <div class="card ot-card">
            <div class="card-body">
                ...
                {!! Form::open(['route' => 'saleReturn.store', 'method' => 'post', 'files' => true, 'class' =>
                'sale-return-form']) !!}
                <div class="row">
                    <div class="col-md-12">
                        <div class="row table-content table-basic">
                            <div class="col-md-12">
                                <input type="hidden" name="sale_id" value="{{$ot_crm_sale_data->id}}">
                                        ...
                                        <tbody class="tbody">
                                            ...
                                            <tr>
                                                <?php
                                                        ...
                                                        $product_batch_data = Modules\Petcare\Entities\SaleProductBatch::select('batch_no')->find($product_sale->product_batch_id);
                                                    ?>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="number"
                                                        ...
                                                        value="{{$product_sale->qty}}" required step="any"
                        ...
                        @if (hasPermission('sales_return_sale_update'))
                        <div class="form-group">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6 form-group warehouse-section">
                        ...
                        <select required name="warehouse_id" class="selectpicker form-control ot-form-control ot-input"
