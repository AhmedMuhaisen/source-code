                            ...
                            <div class="multi-selector">
                                ...
                                <div class="list">
                                    ...
                                    <label for="{{ 'skill' . $skill->id }}" class="task">
                                        <input type="checkbox" onchange="counterSelected()" name="skills[]" class="skills_checkbox" @if(is_array(old('skills')) && in_array($skill->id, old('skills'))) checked @endif id="{{ 'skill' . $skill->id }}" value="{{ $skill->id }}">
                                        {{ $skill->name}}
                                    </label>
                                @endforeach
