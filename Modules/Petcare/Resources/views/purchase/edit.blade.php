                                            ...
                                            <tr>
                                                <?php
                                                        ...
                                                        if($product_purchase->variant_id) {
                                                            $product_variant_data = Modules\Petcare\Entities\SaleProductVariant::FindExactProduct($product_data->id, $product_purchase->variant_id)->select('item_code')->first();
                                                        ...
                                                        $product_batch_data = Modules\Petcare\Entities\SaleProductBatch::select('batch_no', 'expired_date')->find($product_purchase->product_batch_id);
                                                    ?>
